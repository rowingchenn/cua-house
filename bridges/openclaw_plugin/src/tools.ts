...
import { CuaClient } from "./cua-client.ts";
...
async function screenshotResult(client: CuaClient, label: string): Promise<ToolResult> {
...
export function createCuaTools(client: CuaClient) {
  return [
    // ================================================================
    // cua_screenshot
    // ================================================================
    ...
    // ================================================================
    {
      ...
      async execute(
        _id: string,
        params: { x: number; y: number; button?: string; clicks?: number }
      ): Promise<ToolResult> {
    ...
    // ================================================================
    {
      ...
      async execute(_id: string, params: { keys: string | string[] }): Promise<ToolResult> {
        let keys: string[];
    ...
    // ================================================================
    {
      ...
      async execute(
        _id: string,
        params: { keys: string | string[]; duration: number }
      ): Promise<ToolResult> {
    ...
    // ================================================================
    {
      ...
      async execute(_id: string, params: { x: number; y: number }): Promise<ToolResult> {
        await client.sendCommand("move_cursor", { x: params.x, y: params.y });
    ...
    // ================================================================
    {
      ...
      async execute(_id: string, params: { button?: string }): Promise<ToolResult> {
        const btn = params.button ?? "left";
    ...
    // ================================================================
    {
      ...
      async execute(
        _id: string,
        params: { start_x: number; start_y: number; end_x: number; end_y: number; button?: string }
      ): Promise<ToolResult> {
        const btn = params.button ?? "left";
    ...
    // ================================================================
    {
      ...
      async execute(
        _id: string,
        params: { direction: string; amount: number; x?: number; y?: number }
      ): Promise<ToolResult> {
    ...
    // ================================================================
    {
      ...
      async execute(_id: string, params: { duration: number }): Promise<ToolResult> {
