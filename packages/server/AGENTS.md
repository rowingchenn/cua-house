...
class RuntimeBackend(Protocol):
    ...
    def prepare_slot(self, *, slot_id, image, cpu_cores, memory_gb, cua_port, novnc_port, lease_id, task_id, task_data) -> Any: ...  # cua_port used for GCP; local uses published_ports
